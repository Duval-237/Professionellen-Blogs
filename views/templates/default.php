...
<html lang="<?= $_SESSION[ 'language' ] ?>">
  <head>
    ...
    <meta property="og:type" content="<?= @$img_page ? 'article' : 'website' ?>">
    <meta property="og:image" content="https://technogan.com/uploads/<?= $img_page ? "articles/{$img_page}" : 'website/capture.jpg' ?>">
    ...
    <meta name="twitter:image" content="https://technogan.com/uploads/<?= @ $img_page ? "articles/{$img_page}" : 'website/capture.jpg' ?>">
  ...
  <body role="document" class="<?= @$_SESSION[ 'theme' ] ?>">
      ...
      <div class="width-page header">
        ...
        <nav class="navbar">
          <ul>
            ...
            <li class="item scroll all-language" title="<?= WORD_LANGUAGE ?>" style="--i:3">
              <span><?= WORD_LANGUAGE ?></span>
              <span>
            ...
            <li class="item scroll connexion" title="<?= WORD_CONNECTION ?>" style="--i:4;">
              <span><?= WORD_CONNECTION ?></span>
              <span>
            ...
            <li class="item btn-theme">
              <span class="btn-dark-mode" title="<?= WORD_DARK_MODE ?>">
              ...
              <span class="btn-light-mode" title="<?= WORD_LIGHT_MODE ?>">
              ...
              <ul class="menu-profil enabl">
                ...
                <li>
                  <a href="">
                    ...
                    <span class="text"><?= WORD_ACCOUNT ?></span>
                  </a>
                </li>
                <li>
                  <a href="/Collection">
                    ...
                    <span class="text"><?= WORD_COLLECTION ?></span>
                  </a>
                </li>
                ...
                <li class="sign-out">
                  <a href="">  
                    ...
                    <span class="text"><?= WORD_LOGOUT ?></span>
                  </a>
                </li>
              </ul>
            </li>
      ...
      <div class="width-page footer">
        ...
        <div class="footer-middle">
          <div class="box-footer-middle Support">
            ...
            <ul>
              <li><a href="" title="<?= WORD_AUTHOR ?>">~ <?= WORD_AUTHOR ?></a></li>
              <li><a href="" title="<?= WORD_CONDITIONS_USE ?>">~ <?= WORD_CONDITIONS_USE ?></a></li>
              <li><a href="" title="<?= WORD_ABOUT ?>">~ <?= WORD_ABOUT ?></a></li>
              <li><a href="" title="<?= WORD_PRIVACY_POLICY ?>">~ <?= WORD_PRIVACY_POLICY ?></a></li>
              <li><a href="" title="<?= WORD_SERVICES ?>">~ <?= WORD_SERVICES ?></a></li>
              <li><a href="" title="<?= WORD_CONTACT ?>">~ <?= WORD_CONTACT ?></a></li>
            </ul>
          </div>
          ...
          <div class="box-footer-middle social-media">
            ...
            <ul>
              ...
              <li class="item whatsapp" style="--clr:#00c200;">
                <a href="https://whatsapp.com/channel/0029Vb2IhUYCMY08U4uSFT3b" target="_blank" title="Whatsapp">
        ...
        <div class="footer-bottom">
          ...
          <p>Copyright © 2025 - <?= date( 'Y')  ?> <?= WORD_COPYRIGHT ?></p>
        ...
        <div class="projet">
          <span><?= WORD_PROJECT_FIRMA ?></span>
          <a href="https://technogan.com">Technogan</a>
          <a href="#">Malicc</a>
        </div>
      </div>
    </footer>
        ...
        <?php if ( isset( $_SESSION[ 'user' ] ) ): ?>
          ...
          <li class="item">
            <a href="">
              ...
              <span class="navbar-mobile-text"><?= WORD_ACCOUNT ?></span>
            </a>
          </li>
          <li class="item">
            <a href="/Collection">
              ...
              <span class="navbar-mobile-text"><?= WORD_COLLECTION ?></span>
            </a>
          </li>
          <li class="item btn-dark-mode border">
            ...
            <span class="navbar-mobile-text"><?= WORD_DARK_MODE ?></span>
          </li> 
          <li class="item btn-light-mode border">
            <span class="navbar-mobile-svg">
              <svg viewBox="0 0 512 512"><path d="M256 159.1c-53.02 0-95.1 42.98-95.1 95.1S202.1 351.1 256 351.1s95.1-42.98 95.1-95.1S309 159.1 256 159.1zM509.3 347L446.1 255.1l63.15-91.01c6.332-9.125 1.104-21.74-9.826-23.72l-109-19.7l-19.7-109c-1.975-10.93-14.59-16.16-23.72-9.824L256 65.89L164.1 2.736c-9.125-6.332-21.74-1.107-23.72 9.824L121.6 121.6L12.56 141.3C1.633 143.2-3.596 155.9 2.736 164.1L65.89 256l-63.15 91.01c-6.332 9.125-1.105 21.74 9.824 23.72l109 19.7l19.7 109c1.975 10.93 14.59 16.16 23.72 9.824L256 446.1l91.01 63.15c9.127 6.334 21.75 1.107 23.72-9.822l19.7-109l109-19.7C510.4 368.8 515.6 356.1 509.3 347zM256 383.1c-70.69 0-127.1-57.31-127.1-127.1c0-70.69 57.31-127.1 127.1-127.1s127.1 57.3 127.1 127.1C383.1 326.7 326.7 383.1 256 383.1z"/></svg>
            </span>
            <span class="navbar-mobile-text"><?= WORD_LIGHT_MODE ?></span>
          </li>
          <?php endif ?>
          <li class="item">
            <a href="/">
          ...
          <li class="item all-language">
            ...
            <span class="navbar-mobile-text"><?= WORD_LANGUAGE ?></span>
          </li>
          <!-- <li class="item">
            <a href="">
              <span class="navbar-mobile-svg">
          ...
          <li class="item connexion">
            ...
            <span class="navbar-mobile-text"><?= WORD_CONNECTION ?></span>
          </li>
          <?php else: ?>
          <li class="item sign-out">
            ...
            <span class="navbar-mobile-text"><?= WORD_LOGOUT ?></span>
          </li>
          <?php endif ?>
        </ul>
      </nav>
      ...
      <div class="container-connexion">
        ...
        <div class="content bx2 login">
          ...
          <div class="description">
            <h2><?= TEXT_TITLE_CONNEXION ?></h2>
            <p><?= TEXT_CONNEXION ?></p>
          </div>
          <div class="errorbx">
            <span class="svg"></span>
            <span class="text"><?= WORD_INVALID_FIELDS ?></span>
          </div>
          <form id="formLogin">
            <div class="boxinput">
              <span class="svg">
              ...
              <div class="inputbx">
                <label for="email"><?= WORD_EMAIL_ADRESSE ?></label>
            ...
            <div class="boxinput">
              ...
              <div class="inputbx">
                <label for="password"><?= WORD_PASSWORD ?></label>
                <input type="password" id="password-login" name="password" placeholder="<?= WORD_ENTER_PASSWORD ?>" required>
              </div>
            </div>
            <button type="button" class="pssd-forget" title="<?= WORD_FORGOT_PASSWORD ?>"><?= WORD_FORGOT_PASSWORD ?></button>
            <div class="buttonbx">
              <input type="submit" class="btn-login" value="<?= WORD_LOGIN ?>">
              <button type="button" class="btn-create" title="create account"><?= WORD_CREATE_ACCOUNT ?></button>
            </div>
          </form>
          <div class="login-with">
            <span><?= WORD_CONTINUE_WITH ?></span>
            <ul>
              <li>
                <a href="#" title="Google">
        ...
        <div class="content bx2 sign-up">
          ...
          <form action="#">
            ...
            <div class="boxinput">
              ...
              <div class="inputbx">
                <label for="password"><?= WORD_PASSWORD ?></label>
                <input type="password" id="password-sign-in" placeholder="<?= WORD_ENTER_PASSWORD ?>" required>
              </div>
            </div>
            <div class="buttonbx">
        ...
        <div class="content bx2 reset-password">
          ...
          <div class="description">
            <h2><?= WORD_RESET_PASSWORD ?></h2>
            <p><?= TEXT_RECEIVE_LINK ?></p>
          </div>
          <div class="errorbx">
            <span class="svg"></span>
            <span class="text"><?= WORD_INVALID_EMAIL ?></span>
          </div>
          <form action="#">
            <div class="boxinput">
              <span class="svg">
    ...
    <div id="pop-up-newsletter">
      ...
      <h3><?= WORD_JOIN_COMMUNITY ?></h3>
      <span><?= TEXT_RECEIVE_NEWS ?></span>
      <a href="https://chat.whatsapp.com/JFQA1OQXAYF8b8xQrH7aA4" class="whatsapp-button" target="_blank" title="Whatsapp">
        <span class="svg">
          <svg viewBox="0 0 175.216 175.552"><defs><linearGradient id="b" x1="85.915" x2="86.535" y1="32.567" y2="137.092" gradientUnits="userSpaceOnUse"><stop offset="0" stop-color="#57d163"/><stop offset="1" stop-color="#23b33a"/></linearGradient><filter id="a" width="1.115" height="1.114" x="-.057" y="-.057" color-interpolation-filters="sRGB"><feGaussianBlur stdDeviation="3.531"/></filter></defs><path fill="#b3b3b3" d="m54.532 138.45 2.235 1.324c9.387 5.571 20.15 8.518 31.126 8.523h.023c33.707 0 61.139-27.426 61.153-61.135.006-16.335-6.349-31.696-17.895-43.251A60.75 60.75 0 0 0 87.94 25.983c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.312-6.179 22.558zm-40.811 23.544L24.16 123.88c-6.438-11.154-9.825-23.808-9.821-36.772.017-40.556 33.021-73.55 73.578-73.55 19.681.01 38.154 7.669 52.047 21.572s21.537 32.383 21.53 52.037c-.018 40.553-33.027 73.553-73.578 73.553h-.032c-12.313-.005-24.412-3.094-35.159-8.954zm0 0" filter="url(#a)"/><path fill="#fff" d="m12.966 161.238 10.439-38.114a73.42 73.42 0 0 1-9.821-36.772c.017-40.556 33.021-73.55 73.578-73.55 19.681.01 38.154 7.669 52.047 21.572s21.537 32.383 21.53 52.037c-.018 40.553-33.027 73.553-73.578 73.553h-.032c-12.313-.005-24.412-3.094-35.159-8.954z"/><path fill="url(#linearGradient1780)" d="M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.312-6.179 22.559 23.146-6.069 2.235 1.324c9.387 5.571 20.15 8.518 31.126 8.524h.023c33.707 0 61.14-27.426 61.153-61.135a60.75 60.75 0 0 0-17.895-43.251 60.75 60.75 0 0 0-43.235-17.929z"/><path fill="url(#b)" d="M87.184 25.227c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.313-6.179 22.558 23.146-6.069 2.235 1.324c9.387 5.571 20.15 8.517 31.126 8.523h.023c33.707 0 61.14-27.426 61.153-61.135a60.75 60.75 0 0 0-17.895-43.251 60.75 60.75 0 0 0-43.235-17.928z"/><path fill="#fff" fill-rule="evenodd" d="M68.772 55.603c-1.378-3.061-2.828-3.123-4.137-3.176l-3.524-.043c-1.226 0-3.218.46-4.902 2.3s-6.435 6.287-6.435 15.332 6.588 17.785 7.506 19.013 12.718 20.381 31.405 27.75c15.529 6.124 18.689 4.906 22.061 4.6s10.877-4.447 12.408-8.74 1.532-7.971 1.073-8.74-1.685-1.226-3.525-2.146-10.877-5.367-12.562-5.981-2.91-.919-4.137.921-4.746 5.979-5.819 7.206-2.144 1.381-3.984.462-7.76-2.861-14.784-9.124c-5.465-4.873-9.154-10.891-10.228-12.73s-.114-2.835.808-3.751c.825-.824 1.838-2.147 2.759-3.22s1.224-1.84 1.836-3.065.307-2.301-.153-3.22-4.032-10.011-5.666-13.647"/></svg>
        </span>
