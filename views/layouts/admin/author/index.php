<?php
  $title_page = "Manage Author";
  $file_css = 'views/layouts/admin/author/css/style.css';
  $link_add = '/admin/author/add';
?>
...
<section id="author">
  <ul class="list-author">
    ...
    <li class="content">
      <a href="/admin/author/view/<?= $author->id ?>">
        <div class="bximg">
          <img src="/uploads/author/<?= $author->img ?>" alt="">
        </div>
        <div class="info">
          <span class="name"><?= "$author->first_name $author->name" ?></span>
          <span class="description"><?= $author->description ?></span>
          <span class="date"><?= $author->date ?></span>
        </div>
      </a>
      <div class="action">
        <a href="/admin/author/edit/<?= $author->id ?>" class="edit">
        ...
        <a href="/admin/author/delete/<?= $author->id ?>" class="delete">
