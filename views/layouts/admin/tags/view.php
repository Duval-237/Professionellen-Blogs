<?php
  $title_page = "View Tags";
  $file_css = 'views/layouts/admin/tags/css/view.css';

  foreach ( $tags as $tag )
    $link_add = "/admin/tags/add/{$tag->id}";
?>
  ...
  <ul class="container">  
    ...
    <li class="item">
      <div>
        ...
        <span class="lang"><?= $tag->lang_code ?></span>
        <span class="name"><?= $tag->name ?></span>
        <span class="description"><?= $tag->description ?></span>
      </div>
      <?php if ( $tag->lang_code !== 'fr' ): ?>
      <div class="action">
        <a href="/admin/tags/edit/<?= $tag->id ?>/<?= $tag->lang_code ?>" class="edit">
        ...
        <a href="/admin/tags/delete/<?= $tag->id ?>/<?= $tag->lang_code ?>" class="delete">
