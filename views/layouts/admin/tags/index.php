<?php
  $title_page = "Manage Tags";
  $file_css = 'views/layouts/admin/tags/css/style.css';
  $file_js = '<script src="/views/layouts/admin/tags/js/index.js"></script>';
...
<section id="tags">
  <div class="tab-tags">
    ...
    <div class="content" data-id="<?= $tag->id ?>">
      <span class="svg"><?= $tag->svg ?></span>
      <span class="name"><?= $tag->name ?></span>
      <span class="category" style="--clr:<?= $tag->color ?>; --clr-transparent: <?= $tag->color ?>c2;"><?= $tag->category ?></span>
      <span class="description"><?= $tag->description ?></span>
      <span class="date"><?= $tag->date ?></span>
      <div class="action">
        <a href="/admin/tags/edit/<?= $tag->id ?>" class="edit">
        ...
        <a href="/admin/tags/delete/<?= $tag->id ?>" class="delete">
