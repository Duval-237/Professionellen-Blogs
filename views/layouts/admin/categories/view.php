<?php
  ...
  $file_css = 'views/layouts/admin/categories/css/view.css';
 
  foreach ( $categories as $category ) 
    $link_add = "/admin/categories/add/{$category->id}";
?>
  ...
  <ul class="container">  
    ...
    <li class="item" style="--clr:<?= $category->color ?>; --clr-transparent: <?= $category->color ?>50;">
      <div>
        ...
        <span class="lang"><?= $category->lang_code ?></span>
        <span class="name"><?= $category->name ?></span>
        <span class="description"><?= $category->description ?></span>
      </div>
      <?php if ( $category->lang_code !== 'fr' ): ?>
      <div class="action">
        <a href="/admin/categories/edit/<?= $category->id ?>/<?= $category->lang_code ?>" class="edit">
        ...
        <a href="/admin/categories/delete/<?= $category->id ?>/<?= $category->lang_code ?>" class="delete">
