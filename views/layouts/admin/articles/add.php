  ...
  <form action="/admin/articles/add" method="post" enctype="multipart/form-data">
    <div class="inputbx">
      ...
      <label for="img_intro">
        ...
        <input type="file" name="miniature" id="img_intro" required>
      </label>
    </div>
    <div class="inputbx">
    ...
    <div class="inputbx">
      ...
      <input type="text" name="slug" id="slug" placeholder="technogan.com/" required>
    </div>
    <div class="inputbx">
      <label for="description">Description</label>
      <textarea name="description" id="description" placeholder="Enter the description" required></textarea>
    </div>
    ...
    <div class="inputbx">
      ...
      <textarea name="intro" id="intro" placeholder="Enter the introduction" required></textarea>
    </div>
