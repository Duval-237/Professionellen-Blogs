<?php
$title_page = "Views Articles Traduction";
$file_css = 'views/layouts/admin/articles/css/view.css';

foreach( $articles as $article )
  $link_add = "/admin/articles/add/$article->id_article";
