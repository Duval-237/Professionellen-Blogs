<?php
  $title_page = "Manage Language";
  $file_css = 'views/layouts/admin/language/css/style.css';
  $link_add = '/admin/language/add';
?>
...
<section id="language">
  ...
  <div class="container">
    ...
    <div class="action">
      <a href="/admin/language/edit/<?= $lang->id ?>" class="edit">
      ...
      <a href="/admin/language/delete/<?= $lang->id ?>" class="delete">
