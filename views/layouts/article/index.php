  ...
  <div class="width-page content">
    ...
    <div class="content-post-article">
      <header class="header-post-article">
        ...
        <div class="author"><?= WORD_CO_WRITTING ?> <a href="#"><?= $articles->name ?></a></div>
        <div class="update"><?= WORD_LAST_UPDATE ?>: <time datetime="<?= $articles->date ?>" pubdate="pubdate"><?= $articles->jour ?></time></div>
        <div class="options">
          <div class="download">
            <span>
            ...
            <span><?= WORD_ARTIKEL_DOWNLOAD ?></span>
          </div>
          <div class="share">
            <span>
          ...
          <div class="save <?= isset( $_SESSION[ 'user' ] ) ? 'add-collection' : 'connexion'; ?> <?= $collection == 1 ? 'enable' : ''?> ">
            ...
            <span class="add-text"><?= WORD_ADD_COLLECTION ?></span>
            <span class="remove-text"><?= WORD_REMOVE_COLLECTION ?></span>
          </div>
        </div>
      ...
      <main class="body-post-article">
        <div class="publicite"><?= WORD_ADVERTISING ?></div>
        <?= $articles->content ?>
      ...
      <footer class="footer-post-article">
        ...
        <div class="about-article">
          ...
          <div class="author">
            ...
            <div class="infos">
              <span class="title"><?= WORD_CO_WRITTING ?>:</span>
              <span class="author"><?= $articles->name ?></span>
              <span class="description"><?= $articles->author_description ?></span>
            </div>
          </div>
          <p><?= WORD_ARTICLE_COWRITTEN ?> <?= $articles->name ?>. <?= $articles->info ?> Entourez-vous de personnes bienveillantes et encourageantes pour vous accompagner dans la réalisation de vos projets. Évitez les individus toxiques qui peuvent nuire à votre estime de soi et à votre confiance en vous. Cultiver un cercle social positif est essentiel pour votre développement personnel et votre bien-être. Les personnes qui vous soutiennent et vous encouragent sont une source de motivation et d'inspiration, tandis que les individus toxiques peuvent avoir un impact négatif sur votre mental et votre énergie.</p>
          <span><?= WORD_VIEWED_TIME_START ?> <?= number_format( $articles->view, 0, '', ' ' )  ?> <?= WORD_VIEWED_TIME_END ?></span>
        </div>
        <?php if ( !$avis ): ?>
        <div class="evaluation">
          <h2><?= WORD_USEFUL_ARTICLE ?></h2>
          <div class="box-reponse oui">
            <h3><?= WORD_GREAT ?>!</h3>
            <p><?= WORD_MINUTE_HAVE ?>.</p>
            <form action="#">
              <textarea name="avis" id="message-avis" placeholder="<?= WORD_SAY_THINK ?>" required></textarea>
              <input type="submit" id="btn-send-oui" value="<?= WORD_SEND ?>">
            </form>
          </div>
          <div class="box-reponse non">
            ...
            <form action="#">
              <ul class="list-item">
                <li class="item">
                  <input type="radio" name="non-raison" id="raison1" value="<?= WORD_REASON1 ?>" required>
                  <label for="raison1"><?= WORD_REASON1 ?></label>
                </li>
                <li class="item">
                  <input type="radio" name="non-raison" id="raison2" value="<?= WORD_REASON2 ?>" required>
                  <label for="raison2"><?= WORD_REASON2 ?></label>
                </li>
                <li class="item">
                  <input type="radio" name="non-raison" id="raison3" value="<?= WORD_REASON3 ?>" required>
                  <label for="raison3"><?= WORD_REASON3 ?></label>
                </li>
                <li class="item">
                  <input type="radio" name="non-raison" id="raison4" value="<?= WORD_REASON4 ?>" required>
                  <label for="raison4"><?= WORD_REASON4 ?></label>
                </li>
                <li class="item btn-send">
                  <input type="submit" id="btn-send-non" value="<?= WORD_SEND ?>">
                </li>
              </ul>
            </form>
          </div>
        ...
        <div class="container"> 
          ...
          <ul class="social-media">
            <li class="item facebook" style="--clr:#1877f2;">
              <a href="https://www.facebook.com/sharer/sharer.php?u=https://<?= $_SERVER[ 'HTTP_HOST' ] . '/' . $slugArticle ?>" target="_blank" title="Facebook">
                <svg viewBox="0 0 512 512"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/></svg>
              </a>
              <span>Facebook</span>
            </li>
            <li class="item whatsapp" style="--clr:#00c200;">
              <a href="https://api.whatsapp.com/send?text=https://<?= $_SERVER[ 'HTTP_HOST' ] . '/' . $slugArticle ?>" target="_blank" title="Whatsapp">
            ...
            <li class="item twitter" style="--clr:#000;">
              <a href="https://twitter.com/intent/tweet?url=https://<?= $_SERVER[ 'HTTP_HOST' ] . '/' . $slugArticle ?>" target="_blank" title="X">
    ...
    <section class="content-aside">
      <div class="blog-aside">
        <aside role="complementary" class="infos-articles" >
          ...
          <div class="donnee">
            <div class="update">
              <span class="title"><?= WORD_UPDATE ?></span>
              <span class="value"><?= $articles->jour ?></span>
            </div>
            <div class="views">
              <span class="title"><?= WORD_VIEW ?></span>
...
<div class="container-confirmation" >
  <span class="message-copie"><?= WORD_LINK_KOPIEREN ?></span>
  <span class="message-avis"><?= WORD_THANK_FEEDBACK ?></span>
</div>
